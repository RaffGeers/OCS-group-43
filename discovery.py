...
def hardcoded_discovery():
    group1 = config.discovery.hardcoded_group1
    group2 = config.discovery.hardcoded_group2
    interface_name = config.discovery.hardcoded_interface
...
def dynamic_discovery():
    if config.discovery.automatic_discovery:
